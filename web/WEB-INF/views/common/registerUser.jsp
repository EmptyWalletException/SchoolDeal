...
<div class="container-fluid">
    <div class="row">
        ...
        <jsp:include page="../seller/shopLeftBar.jsp"></jsp:include>

        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">

            <jsp:include page="../seller/fastJump.jsp"></jsp:include>
            <hr/>
            <br/>
...
<!--user-defined-js-->
<script src="/resources/js/common/registerUser.js" charset="UTF-8"></script>
