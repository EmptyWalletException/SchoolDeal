        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="container">
                <div class="py-5 text-center">
                    ...
                    <h2>新增商品</h2>
                    <p class="lead">请补充新增的商品信息!</p>
                </div>
                <hr/>

                <div class="row">
                    <div class="col-md-8 order-md-1">
                        <h4 class="mb-3">新增商品</h4>
                        <div class="needs-validation" id="editProductForm"  novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block">必须选择一张商品图片上传!</p>
                            </div>
                            <hr class="mb-4">

                        </div>
                            <button class="btn btn-primary btn-lg btn-block "  id="submit_addProduct">提交表单</button>
                    </div>
                </div>
...
<!--user-defined-js-->
<script src="/resources/js/addProduct.js" charset="UTF-8"></script>
