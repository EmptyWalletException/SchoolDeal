                ...
                <div class="col-lg-12 ">
                        ...
                        <div class="needs-validation" id="registerShopForm"  novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block">一张漂亮的店铺图片更能吸引顾客来前来光临您的店铺.</p>
                            </div>
                            <hr class="mb-4">

                        </div>
                            <button class="btn btn-primary btn-lg btn-block "  id="submit_RegisterShop">提交注册申请</button>
                    </div>
                </div>
...
<!--user-defined-js-->
<script src="/resources/js/seller/registerShop.js" charset="UTF-8"></script>
