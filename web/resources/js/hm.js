(function () {
    var h = {}, mt = {}, c = {
        id: "8dfa8fb7ffbd0407c8562282198066a6",
        dm: ["starbucks.com.cn"],
    ...
    (function () {
        var a = mt.i, b = mt.lang, d = mt.event, g = mt.f, f = h.z, p = h.B, l = [], n = {
            ga: function () {
    ...
    (function () {
        ...
        var f = mt.event, p = h.B, l = t, n = t, e = t, k = t, w = +new Date, m = w, q = 0, x = t,
    ...
    (function () {
        var a = mt.lang, b = h.z, d = h.load, g = {
            Sa: function (f) {
    ...
    (function () {
        ...
        var d = mt.lang, g = mt.l, f = mt.f, p = h.z, l = h.B, n = h.sa, e = {
            s: [], J: 0, ba: v, o: {V: "", page: ""}, init: function () {
                e.e =
                    0;
                l.c("pv-b", function () {
                    e.ta();
                ...
                if (d.d(a, "Object")) {
                    ...
                    if (900 >= m) f.call(this, a); else for (var m = Math.ceil(m / 900), q = "block|" + Math.round(Math.random() * p.w).toString(16) + "|" + m + "|", l = [], r = 0; r < m; r++) l.push(r), l.push(a.substring(900 * r, 900 * r + 900)), f.call(this, q + l.join("|")), l = []
                }
    ...
    (function () {
        ...
        var b = mt.url, d = mt.ea, g = mt.U, f = mt.lang, p = mt.cookie, l = mt.f, n = mt.localStorage,
            e = mt.sessionStorage, k = h.z, w = h.B;
        a.prototype = {
            Q: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                try {
                    p.set(a, b, {domain: this.N(), path: this.Y(), M: d}), d ? n.set(a, b, d) : e.set(a, b)
                } catch (f) {
                }
            }, Ya: function (a) {
                try {
                    p.set(a, "", {domain: this.N(), path: this.Y(), M: -1}), e.remove(a), n.remove(a)
                } catch (b) {
                }
            }, eb: function () {
                var a, b, d, e, f;
            ...
            fb: function () {
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id), e = -1 < document.referrer.indexOf(k.la),
                    f = b.j(a, "jn"), l = /^heatlink$|^select$|^pageclick$/.test(f);
